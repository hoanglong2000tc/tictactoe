...
void guild (); // huong dan cach choi
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void guild ()
{
    cout << "- When choosing 2 players: a game is started when there are 2 players on the table." << endl;
    cout << "  The person has the right to go first: hit any position on the chessboard" << endl;
    cout << "- When choosing to play against the machine: you have the right to go first." << endl;
    cout << "- When it's turn: the player must tick any empty box on the chessboard." << endl;
    cout << "- Tick all 5 boxes vertically, horizontally or diagonally to win." << endl;
}
